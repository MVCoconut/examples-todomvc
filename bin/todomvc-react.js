...
coconut_ui_View.fromHxx = function(props) {
	return React.createElement(react__$ReactNode_ReactNode_$Impl_$.fromComp(coconut_ui_View),props);
};
		...
		if((this3 == null ? 0 : this3.length) > 0) {
			...
			while(_g.list.length > 0) {
				...
				if(tink_state__$Observable_Observable_$Impl_$.get_value(this.__slots.filter.observe()).matches(item[0])) {
					...
					var __ret5 = tink_state__$Observable_Observable_$Impl_$.auto(this4);
					...
					var __ret6 = { key : __ret4, item : __ret5, ondeleted : tink_state__$Observable_Observable_$Impl_$.auto(this5)};
			...
			var __ret8 = tink_state__$Observable_Observable_$Impl_$.auto(this6);
			var this7 = { f : function() {
				return tink_state__$Observable_Observable_$Impl_$.get_value(__o01.__slots.filter.observe());
			}};
			var __ret9 = { todos : __ret8, filter : tink_state__$Observable_Observable_$Impl_$.auto(this7)};
